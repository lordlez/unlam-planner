...
const MateriaCard: React.FC<MateriaCardProps> = ({ materia, estado, puedeCursar, onStatusChange }) => {
    const borderColor = {
        [estados.APROBADA_FINAL]: 'border-green-500',
        [estados.APROBADA_CURSADA]: 'border-yellow-500',
